...
const val WITHDRAWAL_ANSWER1 = "지각 방지에 효과를 못 느꼈어요."
const val WITHDRAWAL_ANSWER2 = "일정 등록이나 사용이 번거로웠어요."
const val WITHDRAWAL_ANSWER3 = "알림이 너무 많거나 타이밍이 맞지 않았어요."
const val WITHDRAWAL_ANSWER4 = "제 생활에 딱히 쓸 일이 없었어요."
