...
import ondot.core.design_system.generated.resources.ic_kakao
...
fun ButtonType.styles(): ButtonStyle =
    when (this) {
        ButtonType.Kakao ->
            ButtonStyle(
                backgroundColor = OnDotColor.Kakao,
                fontColor = OnDotColor.Gray900,
                drawableResource = Res.drawable.ic_kakao,
            )
        ButtonType.Apple ->
            ButtonStyle(
                backgroundColor = OnDotColor.Gray900,
                fontColor = OnDotColor.Gray0,
