package com.ondot.data.adapter
...
object AlarmDetailAsJsonAdapter : ColumnAdapter<Alarm, String> {
    override fun decode(databaseValue: String): Alarm = json.decodeFromString(databaseValue)
    override fun encode(value: Alarm): String = json.encodeToString(value)
}